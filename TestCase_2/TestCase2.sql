...
-- Considere que corridas de taxi validas tenham de 1 a 5 passageiros. Qual a quantidade de corridas feitas com cada n�mero de passageiros?  OK
...
-- Considerando apenas as corridas que houveram pedagios (tolls), qual a m�dia do valor pago em ped�gios por corrida? OK
